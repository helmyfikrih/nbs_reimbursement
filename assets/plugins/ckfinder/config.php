...
// .....
    ...
    $cisess_cookie = $_COOKIE['kms_session'];
    $cisess_cookie = stripslashes($cisess_cookie);
    $cisess_query = "SELECT kms_sessions.data FROM kms_sessions WHERE id = '$cisess_cookie'";
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/kms_multischool/assets/usersFiles/'.$_SESSION["user"]["user_id"],
