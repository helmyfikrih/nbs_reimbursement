	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Reimburse List</li>
			</ul><!-- /.breadcrumb -->
		</div>
		...
		<div class="page-content">
				...
				<div class="clearfix">
					...
					<div class="pull-right">
						<?php if ((in_array($menu_allow . '_add', $user_allow_menu))) { ?>
							<a href="<?= base_url('reimburse/create') ?>" class="btn btn-white btn-info btn-bold">
			...
			<!-- advance search -->
			<div id="kms_filter" class="collapse animated fadeIn" data-parent="#accordion" hidden>
				<div class="row">
					<div class="col-md-12">
	...
	jQuery(function($) {
		...
		var myTable =
			...
			.DataTable({
				...
				"bServerSide": true,
				"ajax": {
					url: "<?= base_url("reimburse/getList/"); ?>",
					type: "POST",
					data: function(f) {
