    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"><?= $this->lang->line('doctype_title') ?></li>
            </ul><!-- /.breadcrumb -->
        </div>

        <div class="page-content">
            <div class="page-header">
                <h1><?= $this->lang->line('doctype_title') ?></h1>
            </div><!-- /.page-header -->
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <table border="0" width="100%">
                                <input type="hidden" id="doctype_id" name="doctype_id" />
                                <tr>
                                    <td><?= $this->lang->line('doctype_name') ?></td>
                                    <td><input type="text" placeholder="Ex: Bahan Ajar" id="doctype_name" name="doctype_name" /></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
            ...
            <div class="dataTables_borderWrap">
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            <th><?= $this->lang->line('doctype_text') ?> ID</th>
                            <th><?= $this->lang->line('doctype_name') ?></th>
                            <th></th>
                        </tr>
                    </thead>
    ...
    jQuery(function($) {
        ...
        var myTable =
            ...
            .DataTable({
                ...
                "bServerSide": true,
                "ajax": {
                    url: "<?= base_url("document_type/getList/"); ?>",
                    type: "POST",
                    data: function(d) {
...
*/
    ...
    function input_designation_data() {
        ...
        ngeklik();
        // loading("tab-content");
        var doctype_id = jQuery("#doctype_id").val();
        var doctype_name = jQuery("#doctype_name").val();
        jQuery.ajax({
            url: "<?= base_url() ?>document_type/save",
            dataType: "json",
            type: "POST",
    ...
    function clearData() {
        jQuery("#doctype_id").val("");
        jQuery("#doctype_name").val("");
    ...
    function editData(e) {
        ...
        jQuery.ajax({
            ...
            url: "<?= base_url() ?>document_type/getOne",
            dataType: "json",
            success: function(e) {
                jQuery("#doctype_id").val(e[0].doctype_id);
                jQuery("#doctype_name").val(e[0].doctype_name);
            }
        });
...
<script>
    function deleteData(id) {
        ...
        var text = '<?= $this->lang->line('doctype_warning_delete') ?>'
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?= base_url('document_type/deleteData/') ?>' + id,
                    type: 'POST',
                    data: {},
                    dataType: 'json',
