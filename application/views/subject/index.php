    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"><?= $this->lang->line('subject_title') ?></li>
            </ul><!-- /.breadcrumb -->
        </div>

        <div class="page-content">
            <div class="page-header">
                <h1><?= $this->lang->line('subject_title') ?></h1>
            </div><!-- /.page-header -->
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <table border="0" width="100%">
                                ...
                                <tr>
                                    <td><?= $this->lang->line('subject_code') ?></td>
                                    <td style="padding-left: 20px;  padding-bottom: 5px;"><input type="text" placeholder="<?= $this->lang->line('subject_code') ?>" id="subject_code" name="subject_code" /></td>
                                </tr>
                                <tr>
                                    <td><?= $this->lang->line('subject_name') ?></td>
                                    <td style="padding-left: 20px;  padding-bottom: 5px;"><input type="text" placeholder="<?= $this->lang->line('subject_name') ?>" id="subject_name" name="subject_name" /></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td style="padding-left: 20px;  padding-bottom: 5px;">
                                        <button name="" id="" class="btn blue" onclick="input_subject_data()">Submit</button>&nbsp;
...
*/
    ...
    function input_subject_data() {
        if (jQuery('#subject_code').val() === '' || jQuery('#subject_name').val() === '') {
            Toast.fire({
                icon: 'warning',
    ...
    function clearData() {
        jQuery("#subject_id").val("");
        jQuery("#subject_code").val("");
    ...
    function editData(e) {
        ...
        jQuery.ajax({
            ...
            url: "<?= base_url() ?>subject/getOne",
            dataType: "json",
            success: function(e) {
                jQuery("#subject_id").val(e[0].subject_id);
                jQuery("#subject_code").val(e[0].subject_code);
                jQuery("#subject_name").val(e[0].subject_name);
            }
        });
...
<script>
    function deleteData(id) {
        ...
        var text = '<?= $this->lang->line('subject_warning_delete') ?>'
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?= base_url('subject/deleteData/') ?>' + id,
                    type: 'POST',
                    data: {},
                    dataType: 'json',
