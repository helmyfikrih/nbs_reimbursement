                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="announ_title" id="announ_title" placeholder="<?= $this->lang->line('announ_title') ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="announ_number" id="announ_number" placeholder="<?= $this->lang->line('announ_number') ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control input-mask-phone date-picker" type="text" id="announ_date" name="announ_date" placeholder="dd/mm/yyyy" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="announ_subject" id="announ_subject" placeholder="<?= $this->lang->line('announ_subject') ?>" required>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="announ_content" class="autosize-transition form-control" name="announ_content" required></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <br>
