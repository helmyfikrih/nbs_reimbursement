    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"><?= $this->lang->line('forum_create') ?></li>
            </ul><!-- /.breadcrumb -->
        </div>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h1><?= $this->lang->line('forum_create') ?> </h1>
            </div><!-- /.page-header -->
                ...
                <div class="col-xs-12">
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control " type="text" id="post_title" name="post_title" placeholder="<?= $this->lang->line('forum_title2') ?>" required>
                        </div>
                    </div>
                    <hr>
                    <div>
                        ...
                        <div class="input-group" style="width: 100%;">
                            ...
                            <div class="inline">
                                <input class="form-control " type="text" id="post_category" name="post_category" placeholder="<?= $this->lang->line('forum_category') ?>" required>
                            </div>
                        </div>
                    </div>
                    <div hidden>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <textarea id="post_content" class="autosize-transition form-control" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 92px;" name="post_content" required></textarea>
                        </div>
                    </div>
