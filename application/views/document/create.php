    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"><?= $this->lang->line('document_create') ?></li>
            </ul><!-- /.breadcrumb -->
        </div>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h1><?= $this->lang->line('document_create') ?></h1>
            </div><!-- /.page-header -->

            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <?php echo form_open_multipart('document/save', 'class="form-horizontal" id="form" role="form"'); ?>
                    <div class="col-md-12">
                        <div class="col-xs-6">
                            <div>
                                ...
                                <input class="form-control" type="text" id="document_name" name="document_name" placeholder="<?= $this->lang->line('document_name') ?>" required>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div>
                                ...
                                <select class="select2 form-control" name="option" id="option" data-placeholder="Pilih Option..." required>
                                    <option value=""> </option>
                    ...
                    <div class="col-md-12 " id="uploadAdditionalData" hidden>
                        <hr>
                        ...
                        <div class="col-xs-6" id="subjectDiv" hidden>
                            <div class="animated fadeIn">
                                ...
                                <select class="select2 form-control" name="subject" id="subject" data-placeholder="Pilih Option..." required>
                                    <option value=""> </option>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            ...
                            <div class="input-group">
                                <textarea id="document_desc" class="autosize-transition form-control" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 92px;" name="document_desc"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12">
        ...
        $(document).ready(function() {
            $('#option').on('select2:select', function(e) {
                ...
                if (data.id == 2) {
                    ...
                    $("#uploadAdditionalData").attr("hidden", false);
            ...
            $('#option').on('select2:unselect', function(e) {
                $("#addFile").attr("hidden", true);
                $("#uploadAdditionalData").attr("hidden", true);
                $(".files").remove();
            });
