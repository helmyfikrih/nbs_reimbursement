    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"><?= $this->lang->line('notulensi_create') ?></li>
            </ul><!-- /.breadcrumb -->
        </div>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h1><?= $this->lang->line('notulensi_create') ?></h1>
            </div><!-- /.page-header -->

            <!-- PAGE CONTENT BEGINS -->
            <?php echo form_open_multipart('notulensi/save', 'class="" id="form" role="form" autocomplete="off"'); ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="notulensi_agenda">
                            <?= $this->lang->line('notulensi_agenda') ?>
                            <small class="text-warning"></small>
                        </label>
                        <input type="text" class="form-control" name="notulensi_agenda" id="notulensi_agenda" placeholder="<?= $this->lang->line('notulensi_agenda') ?>" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="notulensi_leader">
                            <?= $this->lang->line('notulensi_leader') ?>
                            <small class="text-warning"></small>
                        </label>
                        <input type="text" class="form-control" name="notulensi_leader" id="notulensi_leader" placeholder="<?= $this->lang->line('notulensi_leader') ?>" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="notulensi_place">
                            <?= $this->lang->line('notulensi_place') ?>
                            <small class="text-warning"></small>
                        </label>
                        <input type="text" class="form-control" name="notulensi_place" id="notulensi_place" placeholder="<?= $this->lang->line('notulensi_place') ?>" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="notulensi_type">
                        ...
                        <select class="form-control select2" name="notulensi_type" id="notulensi_type" data-placeholder="<?= $this->lang->line('text_select_option') ?>" required>
                            ...
                            <?php foreach ($noteType as $type) { ?>
                                <option value="<?= $type['meetType_id'] ?>"><?= $type['meetType_name'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control input-mask-phone date-picker" type="text" id="notulensi_date" name="notulensi_date" placeholder="dd/mm/yyyy" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="notulensi_start">
                        ...
                        <div class="input-group clockpicker">
                            ...
                            <input class="form-control input-mask-phone" type="text" id="notulensi_start" name="notulensi_start" placeholder="hh:mm" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group clockpicker">
                            ...
                            <input class="form-control input-mask-phone" type="text" id="notulensi_end" name="notulensi_end" placeholder="hh:mm" required>
                        </div>
                    </div>
                </div>
                <!-- <div class="col-md-6">
                    <div class="form-group">
                        <label for="is_public"><?= $this->lang->line('text_make_public') ?></label>
                        <br>
                        <input name="is_public" class="ace ace-switch ace-switch-2" type="checkbox" id="is_public" <?= $system["active_register_role"] == 1 ? '' : '' ?> />
                        <span class="lbl"></span>
                        <p class="text-info"><?= $this->lang->line('text_public_desc') ?></p>
                    </div>
                </div> -->
                <?php
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="notulensi_content">
                            <?= $this->lang->line('notulensi_result') ?>
                            <small class="text-warning"></small>
                        </label>
                        <textarea id="notulensi_content" class="autosize-transition form-control" name="notulensi_content"></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
...
<script>
    $('#form').on('submit', (function(e) {
        e.preventDefault();
        var start = $('#notulensi_start').val();
        var end = $('#notulensi_end').val();
        if (end.replace(":", "") <= start.replace(":", "")) {
            Toast.fire({
                icon: 'warning',
                title: '<?= $this->lang->line('notulensi_clock_warning') ?>'
            })
            return;
        }
        Swal.fire({
