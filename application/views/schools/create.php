    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"><?= $this->lang->line('school_create') ?></li>
            </ul><!-- /.breadcrumb -->
        </div>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h1><?= $this->lang->line('school_create') ?></h1>
            </div><!-- /.page-header -->
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-6">
                        <div>
                            ...
                            <input class="form-control" type="text" id="school_name" name="school_name" placeholder="EX: Madrasah Aliyah 4 Jakarta" required>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div>
                            ...
                            <input class="form-control" type="text" id="school_nsm" name="school_nsm" placeholder="Ex: 1114093000027" required>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <hr>
                    ...
                    <div class="col-xs-6">
                        ...
                        <div>
                            ...
                            <input class="form-control" type="number" id="school_phone" name="school_phone" placeholder="EX: 0212323232" required>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6">
                    ...
                    <div>
                        ...
                        <textarea class="autosize-transition form-control" type="text" id="school_address" name="school_address" placeholder="Ex: Jl. Kayu Manis III RT 06/02 No.41 Pd.Cabe Udik." required></textarea>
                    </div>
                </div>
                <div class="col-xs-6">
                    <hr>
                    <div>
                        ...
                        <select class="select2 form-control" name="school_status" id="school_status" data-placeholder="<?= $this->lang->line('text_select_option') ?>" required>
                            <option value=""></option>
                            <option value="1"><?= $this->lang->line('school_status_active') ?></option>
                            <option value="0"><?= $this->lang->line('school_status_inactive') ?></option>
                        </select>
                    </div>
                </div>
                <div class="col-xs-12">
