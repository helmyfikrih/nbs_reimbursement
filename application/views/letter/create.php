					...
					<div class="col-md-12 " id="uploadAdditionalData">
						...
						<div class="col-xs-6 animated fadeIn">
							<div>
								...
								<input class="form-control" type="text" id="surat_asal" name="surat_asal" placeholder="Asal Surat" required>
							</div>
						</div>
						<div class="col-xs-6" id="subjectDiv">
							<div class="animated fadeIn">
								...
								<input class="form-control" type="text" id="surat_tujuan" name="surat_tujuan" placeholder="Tujuan Surat" required>
							</div>
						</div>
					</div>
					<div class="col-xs-12">
