...
<div class="main-content">
					...
					<div class="col-md-12">
						<div class="col-xs-6">
							<div>
								...
								<input class="form-control" type="text" id="surat_nomor" name="surat_nomor" placeholder="Nomor Surat" required value="<?= P($docDetail[0]['surat_nomor']) ?>">
								<input class="form-control hidden" type="text" id="surat_id" name="surat_id" placeholder="EX: Dokumen Persentasi" required value="<?= $docDetail[0]['surat_id'] ?>">
							</div>
						</div>
						<div class="col-xs-6">
							<div>
								...
								<select class="select2 form-control" name="surat_jenis" id="surat_jenis" data-placeholder="Pilih Option..." required>
									<option value=""> </option>
									<option value="2">SURAT KELUAR</option>
									<option value="3">SURAT MASUK</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12 " id="uploadAdditionalData">
						...
						<div class="col-xs-6 animated fadeIn">
							<div>
								...
								<input class="form-control" type="text" id="surat_asal" name="surat_asal" placeholder="Asal Surat" required value="<?= P($docDetail[0]['surat_asal']) ?>">
							</div>
						</div>
						<div class="col-xs-6" id="subjectDiv">
							<div class="animated fadeIn">
								...
								<input class="form-control" type="text" id="surat_tujuan" name="surat_tujuan" placeholder="Tujuan Surat" required value="<?= P($docDetail[0]['surat_tujuan']) ?>">
							</div>
						</div>
					</div>
					<!-- <div class="col-md-12">
					...
					<div class="col-xs-12">
						...
						<div>
							...
							<div class="input-group">
								<textarea id="surat_keterangan" class="autosize-transition form-control" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 92px; width: 100%;" name="surat_keterangan">
									<?= P($docDetail[0]['surat_keterangan']) ?>
								</textarea>
							</div>
						</div>
					</div>
						...
						<div class="widget-box transparent">
							...
							?>
								<ul class="ace-thumbnails clearfix">
									...
									?>
										<li id="file_<?= $attch['sa_id'] ?>">
											<?php if (in_array($ext, $multimediaArr)) { ?>
												<video width="150" height="150" controls>
													<source src="<?= base_url() ?>assets/uploads/letter/<?= $attch['sa_name'] ?>" type="video/mp4">
													Your browser does not support the video tag.
												</video>
											<?php } else if ($ext == "pdf") { ?>
												<embed width="150" height="150" alt="150x150" src="<?= base_url() ?>assets/uploads/letter/<?= $attch['sa_name'] ?>" />
											<?php } else { ?>
												<a href="<?= base_url() ?>assets/uploads/letter/<?= $attch['sa_name'] ?>" data-rel="colorbox" class="cboxElement">
													<img width="150" height="150" alt="150x150" src="<?= base_url() ?>assets/uploads/letter/<?= $attch['sa_name'] ?>">
												</a>
											<?php } ?>
											<div class="tags">
											...
											<div class="tools">
												<a href="javascript:;" onclick="deleteImg(<?= $attch['sa_id'] ?>)">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#surat_jenis').val(<?= json_decode($docDetail[0]['surat_jenis']) ?>).trigger('change');
