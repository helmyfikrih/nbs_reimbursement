...
class Meet_type_model extends CI_model
{
    ...
    var $order = array('meetType_id' => 'asc'); // default order
    ...
    function insertMeetType($data)
    {
        return $this->db->insert('kms_meeting_type', $data);
    }

    function updateMeetType($data, $cond)
    {
        $this->db->where($cond);
        return $this->db->update('kms_meeting_type', $data);
    }

    function getOne($id)
    {
        $this->db->where('meetType_id', $id);
    ...
    {
        $this->db->where('meetType_id', $id);
        return $this->db->delete('kms_meeting_type');
    }

    function getAllMeetType()
    {
        return $this->db->get('kms_meeting_type')->result_array();
    }
}
